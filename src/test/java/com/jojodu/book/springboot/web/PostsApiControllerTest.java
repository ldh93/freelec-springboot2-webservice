...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        HttpEntity<PostsUpdateRequestDto> requestEntitiy = new HttpEntity<>(requestDto);

        //when
        ResponseEntity<Long> responseEntity = restTemplate.exchange(url, HttpMethod.PUT, requestEntitiy, Long.class);
